...
const colors = [
  ...
  {
    main: staticAccentColor,
    darken: staticAccentDarkenColor,
  },
  {
    main: '#FF4C51',
    darken: '#E64449',
...
const customPrimaryColor = ref(staticPrimaryColor)
...
const resetCustomizer = async () => {
  if (isCookieHasAnyValue.value) {
    ...
    vuetifyTheme.themes.value.dark.colors.primary = staticDarkPrimaryColor
    vuetifyTheme.themes.value.light.colors['primary-darken-1'] = staticPrimaryDarkenColor
    vuetifyTheme.themes.value.dark.colors['primary-darken-1'] = staticDarkPrimaryDarkenColor
    ...
    customPrimaryColor.value = staticPrimaryColor
  }
}
</script>
