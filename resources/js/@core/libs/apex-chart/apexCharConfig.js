...
const brandChartColors = themeColors => {
  const primary = themeColors.colors.primary
  const secondary = themeColors.colors.secondary
  const primarySoft = `rgba(${hexToRgb(primary)}, 0.55)`
  const secondarySoft = `rgba(${hexToRgb(secondary)}, 0.42)`
  const backgroundSoft = `rgba(${hexToRgb(themeColors.colors['on-surface'])}, 0.08)`
...
export const getScatterChartConfig = themeColors => {
  const brandColors = brandChartColors(themeColors)
  const scatterColors = {
    series1: brandColors.secondary,
    series2: brandColors.primary,
    series3: brandColors.blush,
  }
...
export const getRadialBarChartConfig = themeColors => {
  ...
  const radialBarColors = {
    series1: brandColors.secondary,
    series2: brandColors.primary,
    series3: brandColors.primarySoft,
    series4: brandColors.blush,
    series5: brandColors.secondarySoft,
  }
...
export const getDonutChartConfig = themeColors => {
  ...
  const donutColors = {
    ...
    series2: brandColors.primary,
    series3: brandColors.blush,
    series4: brandColors.primarySoft,
    series5: brandColors.secondarySoft,
  }
...
export const getAreaChartSplineConfig = themeColors => {
  const brandColors = brandChartColors(themeColors)
  const areaColors = {
    series3: brandColors.secondarySoft,
    series2: brandColors.primarySoft,
    series1: brandColors.primary,
  }
...
export const getColumnChartConfig = themeColors => {
  ...
  const columnColors = {
    series1: brandColors.primary,
    series2: brandColors.secondary,
    bg: brandColors.backgroundSoft,
  }
  ...
  return {
    ...
    plotOptions: {
      heatmap: {
        ...
        colorScale: {
          ranges: [
            { to: 10, from: 0, name: '0-10', color: brandColors.secondarySoft },
            { to: 20, from: 11, name: '10-20', color: '#E6D38B' },
            { to: 30, from: 21, name: '20-30', color: '#C75C6D' },
            { to: 40, from: 31, name: '30-40', color: '#A83E50' },
            { to: 50, from: 41, name: '40-50', color: brandColors.muted },
            { to: 60, from: 51, name: '50-60', color: brandColors.primary },
          ],
        },
      },
    },
