...
const navLinks = [
  { title: 'خانه', id: 'home' },
  { title: 'امکانات', id: 'features' },
  { title: 'نمای پنل', id: 'showcase' },
  { title: 'قیمت', id: 'pricing-plan' },
  { title: 'سوالات', id: 'faq' },
  { title: 'تماس', id: 'contact-us' },
]

const menuItems = [
  {
    listTitle: 'صفحات سایت',
    listIcon: 'tabler-layout-grid',
    navItems: [
      { name: 'قیمت‌گذاری', to: { name: 'front-pages-pricing' } },
      { name: 'درباره ما', to: { name: 'front-pages-about' } },
      { name: 'مرکز راهنما', to: { name: 'front-pages-help-center' } },
      { name: 'حریم خصوصی', to: { name: 'front-pages-privacy' } },
      { name: 'شرایط استفاده', to: { name: 'front-pages-terms' } },
    ],
  },
]
      ...
      <div>
        <div class="d-flex flex-column gap-y-4 pa-4">
          <RouterLink
            ...
            :class="[props.activeId === link.id ? 'active-link' : '']"
          >
            {{ link.title }}
          </RouterLink>

          <RouterLink
            :to="{ name: 'front-pages-about' }"
            class="nav-link font-weight-medium"
          >
            درباره ما
          </RouterLink>
          ...
          <div class="font-weight-medium cursor-pointer">
            ...
            >
              صفحات <VIcon :icon="isMenuOpen ? 'tabler-chevron-up' : 'tabler-chevron-down'" />
            </div>
